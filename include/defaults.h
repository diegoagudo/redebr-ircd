...
#define NETWORK_NAME_DEFAULT "RedeBrasil"	                    /* default for network_name */
#define NETWORK_DESC_DEFAULT "RedeBrasil de Servidores de IRC"	/* default for network_desc */
...
#define SERVICES_NAME_DEFAULT "Services.RedeBrasil.Org.Br"	/* default for services_name */
